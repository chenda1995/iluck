...
<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">轮播修改页</div>
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form action="/admin/show/{{$res->bid}}" method='post' class="am-form tpl-form-border-form tpl-form-border-br" enctype='multipart/form-data'>

                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">轮播地址 </label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="burl" value="{{$res->burl}}" class="tpl-form-input" id="user-name" placeholder="请输链接地址">
                                        </div>
                                    </div>
                                        ...
                                        <div class="am-u-sm-9">
                                            <div class="am-form-group am-form-file">
                                                <div class="tpl-form-file-img">
                                                    <img src="{{$res->bsrc}}" alt="" width='120px' height='120px'>
                                                </div>
