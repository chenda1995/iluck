...
<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form action="/admin/adv" method='post' class="am-form tpl-form-border-form tpl-form-border-br" enctype='multipart/form-data'>

                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">广告地址 </label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="adurl" class="tpl-form-input" id="user-name" placeholder="请输链接地址">
                                        </div>
                                    </div>
