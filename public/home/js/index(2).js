...
function(__WEBPACK_EXTERNAL_MODULE_6__) {
    return function(t) {
        function e(n) {
        ...
        function(t, e) {
            ...
            i.Util = {
                ...
                show: function(e, i) {
                    ...
                    o.length <= 0 && (o = t(['<div class="vp_wrap" id="vp_wrap">', '<h5 class="vp_t"></h5>', '<a href="javascript:;" class="vp_cls">\xd7</a>', '<div class="v_pop_box"></div>', "</div>"].join("")), t("body").append(o), r.off("click").on("click",
                    function() {
                        clearTimeout(s),
                        o.addClass("vp_shake"),
                    ...
                    i.isShowCloser ? o.find(".vp_cls").show() : o.find(".vp_cls").hide(),
                    o.find(".vp_t").html(i.title),
                    a = {
                        alert: function(e) {
                            return n = t(".vp_alert"),
                            n.length <= 0 ? n = t(['<div class="vp_alert vp_inner">', '<p class="vp_cnt"></p>', '<a href="javascript:;" class="vp_btn vp_btn_' + e.btn.theme + ' vp_ok">' + e.btn.text + "</a>", "</div>"].join("")) : n.find(".vp_btn").removeClass("vp_btn_red").removeClass("vp_btn_normal").addClass("vp_btn_" + e.btn.theme).html(e.btn.text),
                            n.show().find(".vp_cnt").html(e.content),
                            n
                        },
                        confirm: function(e) {
                            if (n = t(".vp_cfm"), n.length <= 0) n = t(['<div class="vp_cfm vp_inner">', '<p class="vp_cnt"></p>', '<a href="javascript:;" class="vp_btn vp_btn_' + e.btn1.theme + ' vp_ok">' + e.btn1.text + "</a>", '<a href="javascript:;" class="vp_btn vp_btn_' + e.btn2.theme + ' vp_cancel">' + e.btn2.text + "</a>", "</div>"].join(""));
                                ...
                                var i = n.find(".vp_btn");
                                i.removeClass("vp_btn_red").removeClass("vp_btn_normal"),
                                i.eq(0).addClass("vp_btn_" + e.btn1.theme).html(e.btn1.text),
                                i.eq(1).addClass("vp_btn_" + e.btn2.theme).html(e.btn2.text)
                            }
                            return n.show().find(".vp_cnt").html(e.content),
                            n
                        }
                    },
                    o.find(".v_pop_box").append(a[e](i)),
                    o.css({
                        display: "block",
                        opacity: 0
                    }).css({
                ...
                close: function(e, i) {
                    t(".light_box_fullbg").eq(0).hide(),
                    t("#vp_wrap").find(".vp_inner").hide().end().hide(),
                    void 0 !== i && "function" == typeof i && i(e)
                }
            },
            t.alert = function(e, n, a) {
                ...
                a),
                o = function() {
                    t("#vp_wrap").off("click").on("click", ".vp_ok",
                    function(t) {
                        t.preventDefault(),
                        i.Util.close(s.btn.val, n)
                    }).on("click", ".vp_cls",
                    function(t) {
                        t.preventDefault(),
                        i.Util.close(s.close_val, n)
                    })
                }; !
                function() {
                    i.Util.mask(),
            ...
            t.confirm = function(e, n, a) {
                ...
                o = function() {
                    ...
                    function(t) {
                        t.preventDefault(),
                        i.Util.close(s.btn1.val, n)
                    }).on("click", ".vp_cancel",
                    function(t) {
                        t.preventDefault(),
                        i.Util.close(s.btn2.val, n)
                    }).on("click", ".vp_cls",
                    function(t) {
                        t.preventDefault(),
                        i.Util.close(s.close_val, n)
                ...
                function() {
                    i.Util.mask(),
                    i.Util.show("confirm", s),
                    o()
                } ()
            },
            e.MOGU.alert = t.alert,
            e.MOGU.confirm = t.confirm
        } (jQuery, window)
    },
    function(t, e) {
        "use strict";
    ...
    function(module, exports, __webpack_require__) {
        var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__, BASE = __webpack_require__(5);
        __WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(6)],
        __WEBPACK_AMD_DEFINE_RESULT__ = function(MoGu) {
            return window.__CUtil = window.__CUtil || {
                _getPageType: function() {
                    return this.__pagetype || (this.__pagetype = $("#J_PageType").val()),
                    this.__pagetype
                },
                isNewPrice: function() {
                ...
                getShopId: function() {
                    return this.__shopId || (this.__shopId = this.getQueryString("__shopId"), this.__shopId = this.__shopId || $("#J_ShopId").val()),
                    this.__shopId
                },
                getItemId: function() {
                    return this.__itemId || (this.__itemId = this.getQueryString("__itemId"), this.__itemId = this.__itemId || $("#J_ItemId").val()),
                    this.__itemId
                },
                getShopUserId: function() {
                    return this.__shopUserId || (this.__shopUserId = this.getQueryString("__sellerId"), this.__shopUserId = this.__shopUserId || $("#J_ShopUserId").val()),
                    this.__shopUserId
                },
                getSellerId: function() {
                    return this.__sellerId || (this.__sellerId = this.getQueryString("__sellerId"), this.__sellerId = this.__sellerId || $("#J_SellerId").val()),
                    this.__sellerId
                },
                getRushId: function() {
                    return this.__rushid || (this.__rushid = this.getQueryString("__rushid"), this.__rushid = this.__rushid || $("#J_RushId").val()),
                    this.__rushid
                },
                getSeckillId: function() {
                    return this.__seckillid || (this.__seckillid = this.getQueryString("__seckillid"), this.__seckillid = this.__seckillid || $("#J_SeckillId").val()),
                    this.__seckillid
                },
                ...
                isLogin: function(t) {
                    if (!detailInfo.isLogin) {
                        ...
                        t || {});
                        return MOGU.user_handsome_login_init(),
                        MOGU.user_handsome_login(!1, e),
                        !1
                    }
                    return ! 0
                },
    ...
    function(t, e, i) {
        ...
        a = function(t) {
            ...
            b = window.detailInfo && window.detailInfo.skuInfo,
            k = window.detailInfo && window.detailInfo.itemInfo || {},
            I = !!b.limitTotalStock,
            x = window.detailInfo && window.detailInfo.pinTuanInfo || {},
            S = !(!x.skuInfo || !x.skuInfo.totalStock),
            C = -1 !== location.pathname.indexOf("/jiajiagou/detail/"),
            P = {
            ...
            T = {
                init: function() {
                    12 === P.type && window.logger && window.logger.goTo("//h5.mogujie.com/detail-baihuo/index.html?itemId=" + window.detailInfo.itemId),
                    13 === P.type && window.logger && window.logger.goTo("//h5.mogujie.com/detail-normal-preview/index.html?itemId=" + window.detailInfo.itemId),
                    p.init(w);
                    ...
                    i > 1728e5 ? $(".sale-time").html("\u5f00\u552e\u65f6\u95f4 " + n) : 0 === e ? ($(".sale-time").html("\u5f00\u552e\u5012\u8ba1\u65f6 00:00:00"), $(".sale-time").addClass("c")) : ($(".sale-time").html('\u5f00\u552e\u5012\u8ba1\u65f6 <span id="J_Ready_Sale" cut-time="' + e + '"></span>'), $(".sale-time").addClass("c")),
                    "rush" == window.detailInfo.detailType ? m.init() : f.init(),
                    S ? (this.initPintuanPrice(), l.setData(P.sku, x.skuInfo)) : ($(".property-box.hide").removeClass("hide"), l.setData(P.sku)),
                    C && this.initJiajiagou(),
                    this.initModou(),
                    this.sku(),
                    this.smallImgs(),
                    this.bindEvent()
                ...
                bindEvent: function() {
                    if (this.cpclog(), this.rushBuy(), this.buyNow(), this.buyCart(), this.switchImg(), this.skuPannel(), this.updateSku(), this.chooseSku(), this.stockTip(), this.limitPriceNum(), this.switchFav(), this.switchShare(), this.changeSkuForDapei(), this.changeSku(), this.addqrcode(), d.init(y, $("body"), P.skuInfo.limitTotalStock), detailInfo.isMoguer) {
                        var t = detailInfo.itemId;
                        h.init(t)
                    }
                    $("#J_CountDown").length > 0 && c.init($("#J_CountDown"), g.countDown),
                    $("#J_Ready_Sale").length > 0 && u.init($("#J_Ready_Sale"), g.readySaleCountDown)
                },
                sku: function() {
                    var e = null;
                    try {
                        ...
                        o.sendErrorMsg("sku\u6570\u636e\u5f02\u5e38\uff1a" + i.message),
                        $.alert("\u5546\u54c1\u4fe1\u606f\u51fa\u9519\u4e86\uff0c\u8bf7\u9ebb\u70e6\u8054\u7cfb\u5ba2\u670d\u5904\u7406\uff0c\u8c22\u8c22")
                    }
                    if ("undefined" != typeof e && e) {
                        ...
                        if (n && a > 0) {
                            for (var u in n) {
                                ...
                                n[u].disable ? p.className = p.className + " disable": 1 == a ? (p.className = p.className + " c", P.filter.styleId = u) : P.filter.styleId == u && (p.className = p.className + " c"),
                                d.push(t.ui.getTemplate(g.sku, p))
                            }
                        ...
                        if (s && r > 0) {
                            for (var u in s) {
                                ...
                                s[u].disable ? p.className = p.className + " disable": 1 == r ? (p.className = p.className + " c", P.filter.sizeId = u) : P.filter.sizeId == u && (p.className = p.className + " c"),
                                c.push(t.ui.getTemplate(g.sku, p))
                            }
                ...
                fresh: function() {
                    if ("undefined" != typeof P.skuItems && P.skuItems) {
                        var t = l.getSkuItem(P.filter, P.skuItems);
                        t && (this.price(t), this.stock(t.stock), this.list(t), P.choose = t)
                    }
                },
                stock: function(e) {
                    ...
                    y.attr("data-stock", e),
                    $("body").trigger("stockTip", [y.find(".num-input").val(), y.attr("data-stock")])
                },
                list: function(t) {
                    var e = t.stocks,
                    i = 0;
                    if (e) {
                        ...
                        if (P.skuItems.size) for (var s in P.skuItems.size) {
                            var o = P.skuItems.size[s];
                            if (o) if (o.stocks) for (var n in o.stocks) i += o.stocks[n] || 0;
                            else o.stock && (i += o.stock || 0)
                        }
                        if (0 == i && P.skuItems.style) for (var r in P.skuItems.style) {
                            var l = P.skuItems.style[r];
                            if (l) if (l.stocks) for (var n in l.stocks) i += l.stocks[n] || 0;
                ...
                price: function(t) {
                    if ("undefined" != typeof t && t) {
                        ...
                        a = "",
                        s = "";
                        "number" == typeof t.price ? n = "\xa5" + (t.price / 100).toFixed(2) : e.lowPrice && (n = "\xa5" + e.lowPrice, e.highPrice && e.lowPrice !== e.highPrice && (n += "~\xa5" + e.highPrice)),
                        "number" == typeof t.nowprice ? a = "\xa5" + (t.nowprice / 100).toFixed(2) : i.nowPrice && (a = i.nowPrice),
                        "number" == typeof t.pinTuanPrice ? s = "\xa5" + (t.pinTuanPrice / 100).toFixed(2) : x.skuInfo && x.skuInfo.priceRange && (s = x.skuInfo.priceRange),
                        S ? (a === n && (n = ""), $("#J_OriginPrice").remove(), $("#J_NowPrice").replaceWith('\n                    <span id="J_NowPrice" class="price">' + a + '</span>\n                    <span id="J_OriginPrice" class="price">' + n + "</span>\n                    "), $("#J_PintuanPrice").text(s)) : ($("#J_OriginPrice").text(n), $("#J_NowPrice").text(a))
                    }
                },
                initPintuanPrice: function() {
                    $("body").addClass("is-pintuan"),
                    $("#J_OriginPrice").parents(".property-box").remove();
                    var t = I ? "\u798f\u5229\u4ef7\uff1a": "\u73b0\u4ef7\uff1a";
                    $(".property-type-now").text(t),
                    $("#J_BuyNow").text("\u73b0\u4ef7\u5355\u72ec\u8d2d\u4e70"),
                    $("#J_BuyCart").html('<i class="m-icon m-icon-shopping-cart"></i>'),
                    $(".property-type-now").parent().after('\n                <dl id="J_PintuanPrice_Wrap" class="clearfix property-box"> \n                    <dt class="property-type">' + x.tuanNum + '\u4eba\u62fc\u56e2\uff1a</dt>\n                    <dd class="property-cont fl"><span id="J_PintuanPrice" class="price"></span></dd>\n                </dl>\n                '),
                    $("#J_BuyNow").before('<a href="javascript:;" id="J_PinTuanBuy" class="fl mr10 buy-btn buy-now">' + x.tuanNum + "\u4eba\u62fc\u56e2\u8d2d\u4e70</a>"),
                    $(".property-box.hide").removeClass("hide")
                },
                initModou: function() {
                    var t = k.extra && k.extra.modouDiscount;
                    if (t) {
                ...
                initJiajiagou: function() {
                    $("#J_BuyCart,#J_ModulePromotions,#J_ModuleCustomProperty,#J_ModuleDapei").remove(),
                    $(".only-mobile-price,.goods-social .fav").remove(),
                    $("#J_GoodsNum .num-add").addClass("num-disable"),
                    $("#J_GoodsNum .num-input").attr("disabled", "true"),
                    $(".J_GoodsStockTip").before('<span class="jiajiagou-tip">\u6362\u8d2d\u4ef7\uff0c\u9650\u8d2d1\u4ef6</span>');
                    var t = 2018 === k.priceChannel;
                ...
                smallImgs: function() {
                    if ("undefined" != typeof P.skuItems && P.skuItems) {
                        var t = P.skuItems.style,
                        e = (P.sku.main || {}).topImages || [],
                        i = [];
                        if (t) {
                            if (P.threeDModel) {
                                var a = P.threeDModel.small,
                                s = (P.threeDModel.model, P.threeDModel.snapshot);
                                i.push('<li class="three-d-model"><img src="' + (a || s) + '"><i></i></li>')
                            }
                            if (e) for (var o = 0,
                            r = e.length; r > o; o++) i.push('<li><img src="' + e[o] + '_100x100.jpg"><i></i></li>');
                            return i.length <= 1 ? void n.hide() : void n.find("ul").html(i.join(""))
                        }
                    }
                },
                changeSkuForDapei: function() {
                    $("body").on("dapeiSkuSelect",
                    function(t, e) {
                ...
                switchImg: function() {
                    ...
                    function() {
                        ...
                        $(this).hasClass("three-d-model") ? (a.hide(), $threeDModel.show()) : ($threeDModel.hide(), a.show(), a[0].src = t.replace("_100x100.jpg", "_468x468.jpg"))
                    }),
                    $threeDModel.find(".show-full").on("click",
                    function() {
                        $(".full-threed-view").show()
                    }),
                    $(".full-threed-view-icon").on("click",
                    function() {
                ...
                chooseSku: function() {
                    v.on("click", "ol li:not(.disable)",
                    function() {
                        $("body").trigger("updateSku", [$(this)]),
                        $("body").trigger("stockTip", [y.find(".num-input").val(), y.attr("data-stock")]),
                        D.isBuy() && v.find(".J_PannelOK").css("display", "inline-block").prev().hide(),
                        $("body").trigger("dapeiSkuSelect", [P.filter])
                    })
                },
                updateSku: function() {
                    var t = this;
                    ...
                    function(e, i) {
                        ...
                        if (i.hasClass("c")) {
                            if (n.hasClass("J_StyleList")) {
                                ...
                                if (i.removeClass("c"), delete P.filter.styleId, t.sku(), l.getSizeLen() > 0 && P.filter.sizeId) {
                                    var s = $('.J_SizeList li[data-id="' + P.filter.sizeId + '"]').removeClass("c");
                            ...
                            if (n.hasClass("J_SizeList")) {
                                ...
                                if (i.removeClass("c"), delete P.filter.sizeId, t.sku(), l.getStyleLen() > 0 && P.filter.styleId) {
                                    var o = $('.J_StyleList li[data-id="' + P.filter.styleId + '"]').removeClass("c");
                                    $("body").trigger("updateSku", [o])
                                }
                            }
                        } else i.addClass("c").siblings().removeClass("c"),
                        n.hasClass("J_StyleList") && (P.filter.styleId = i.data("id"), P.filter.type = "style"),
                        n.hasClass("J_SizeList") && (P.filter.sizeId = i.data("id"), P.filter.type = "size"),
                        i.data("src") && t.bigImg(i.data("src")),
                        t.fresh()
                    })
                },
                stockTip: function() {
                    ...
                    function(t, e, i, n) {
                        ...
                        s = -1,
                        o = 1 / 0;
                        S && 0 != x.limitNum && (o = x.limitNum);
                        var r = ["\u60a8\u6240\u586b\u5199\u7684\u5546\u54c1\u6570\u91cf\u8d85\u8fc7\u5e93\u5b58\uff01", "\u8be5\u5546\u54c1\u6bcf\u4f4d\u7528\u6237\u81f3\u591a\u53ea\u80fd\u8d2d\u4e70" + o + "\u4efd\uff01"]; + e > +i ? s = 0 : +e > o && (s = 1),
                        -1 !== s ? (a.text(r[s]).show(), P.isStock = 0) : (a.hide(), P.isStock = 1)
                    })
                },
                limitPriceNum: function() {
                    var t = this;
                    $("body").on("limitPriceNum",
                    function(e, i, n) {
                        t.showLoading(),
                        $.ajax({
                            ...
                            if (e.success && "1001" === e.returnCode && e.data && e.data.data) {
                                var i = e.data.data;
                                window.detailInfo.attribute = i.skus,
                                window.detailInfo.skuInfo = i,
                                P.sku = window.detailInfo || {},
                                P.skuInfo = i,
                                l.setData(P.sku),
                                t.sku()
                            }
                ...
                rushBuy: function() {
                    $("#J_ModuleRushBuy").on("click", 'a[data-type="buynow"]',
                    function() {
                        if (v.data("btn", $(this)), D.isBuy()) {
                            if ($("body").trigger("stockTip", [y.find(".num-input").val(), y.attr("data-stock")]), P.isStock && !$(this).hasClass("buy-disabled")) {
                                var e = D.getParams();
                    ...
                    var t = function(t) {
                        try {
                            window.logger && logger.log("016000112", {
                                num: t.num,
                                price: (P.choose.price / 100).toFixed(2),
                                disprice: (P.choose.nowprice / 100).toFixed(2),
                                stockId: t.stockId,
                        ...
                        var i = {
                            num: t && t.num || "",
                            price: P && P.choose && (P.choose.price / 100).toFixed(2) || "",
                            disprice: P && P.choose && (P.choose.nowprice / 100).toFixed(2) || "",
                            stockId: t && t.stockId || ""
                        },
                        n = $("<form>"),
                        ...
                        a.push('<input type="hidden" name="postdata" value="' + t.stockId + ',1" />'),
                        a.push('<input type="hidden" name="stockptp" value=' + t.ptp + ">"),
                        a.push('<input type="hidden" name="ptp" value=' + t.ptp + ">"),
                        a.push('<input type="hidden" name="channel" value="channel_kuaiqiang">'),
                        a.push('<input type="hidden" name="marketType" value="market_mogujie">'),
                        a.push('<input type="hidden" name="activityId" value="' + s.getQueryString("objectId") + '">'),
                        a.push('<input type="hidden" name="activityType" value="1">'),
                        a.push('<input type="hidden" name="orderFrom" value="detail">'),
                        a.push('<input type="hidden" name="pageEventData" value=' + JSON.stringify(i) + ">"),
                        a = a.join("");
                ...
                buyNow: function() {
                    var t = this;
                    $("#J_BuyNow,#J_PinTuanBuy").on("click",
                    function() {
                        if (!$(this).hasClass("disable")) {
                            var t = "J_PinTuanBuy" === $(this).attr("id");
                            if (v.data("btn", $(this)), D.isBuy()) {
                                if ($("body").trigger("stockTip", [y.find(".num-input").val(), y.attr("data-stock")]), P.isStock) {
                                    var i = D.getParams();
                    ...
                    var e = function(t, e) {
                        window.detailInfo && window.detailInfo.shopInfo && window.detailInfo.shopInfo.nonsupportReasonRefound ? $.confirm("\u6b64\u5546\u54c1\u4e0d\u652f\u63017\u5929\u65e0\u7406\u7531\u9000\u8d27</br>\u8bf7\u77e5\u6653\u54e6",
                        function(e) {
                            e && i(t)
                        },
                        {
                    ...
                    i = function(e, i) {
                        ...
                        if (s.isNewPrice() || C) {
                            ...
                            u = "channel_xinren",
                            p = 1;
                            C && (u = "channel_jiajiagou", p = 7),
                            d.push('<input type="hidden" name="channel" value=\'' + u + "'>", '<input type="hidden" name="activityId" value=\'' + c + "'>", '<input type="hidden" name="activityType" value=\'' + p + "'>")
                        }
                        d = d.join(""),
                        l.attr({
                        ...
                        $("body").append(l),
                        s.isNewPrice() ? (t.showLoading(), $.ajax({
                ...
                buyCart: function() {
                    ...
                    $("#J_BuyCart").on("click",
                    function(n) {
                        if (!detailInfo.isLogin) return MOGU.user_handsome_login_init(),
                        void MOGU.user_handsome_login(!1, {
                            callback: function() {
                                detailInfo.isLogin = !0,
                                $("#J_BuyCart").trigger("click")
                            }
                        });
                        var a = $(n.srcElement || n.target);
                        if (! (a.length > 0 && "J_ModuleCartLuckyDrawTip" == a.attr("id"))) {
                            var o = $(this);
                            if (!o.hasClass("buy-disable")) if (v.data("btn", $(this)), D.isBuy()) {
                                if ($("body").trigger("stockTip", [y.find(".num-input").val(), y.attr("data-stock")]), P.isStock) {
                                    var r = D.getParams();
                                    if (r.detailrefer = window.M.fn.escapeHtml(decodeURIComponent($("#J_DetailRefer").val())), r.cdtype = s.getQueryString("cdtype"), r.price = P.choose.nowprice, top.location != self.location) {
                                        var l = D.getBuyURL("WX_CART", r);
                                        return void window.open(l)
                                    }
                                    o.addClass("buy-disable"),
                                    clearTimeout(i),
                                    ...
                                    f = function() {
                                        ...
                                        function() {
                                            ...
                                            function() {
                                                ...
                                                t(),
                                                $(window).off(".addcartbox").on("resize.addcartbox",
                                                function() {
                                                    t()
                                                })
                                            } () : !c && i.length <= 0 && !
                    ...
                    window.__DetailBuyCartEnable = function() {
                        clearTimeout(i),
                        $("#J_BuyCart:visible").removeClass("buy-disable")
                    }
                },
                flyToChart: function(t, e) {
                    ...
                    if (n.length <= 0 && (n = $(".J_PannelOK:visible").eq(0)), !(n.length <= 0)) {
                        ...
                        r = 0,
                        l = 0;
                        t.pageX && t.pageY ? (r = t.pageX, l = t.pageY - o - 20) : (r = n.offset().left - s + n.outerWidth() / 2, l = n.offset().top - o + n.outerHeight() / 2),
                        a.fly({
                            start: {
                                left: r,
                                top: l
                ...
                skuPannel: function() {
                    ...
                    function(t) {
                        ...
                        e.pageX = t.pageX,
                        e.pageY = t.pageY,
                        v.removeClass("goods-pannel").data("btn").trigger(e)
                    })
                },
                        ...
                        if (e.pf = "mgjpc", e.mids = window.detailInfo.itemId, e.markType = 2, e.ptpCnt = logger.ptp.getPtpCnt() || "", !t) {
                            ...
                            $.ajax({
                                ...
                                if (t.success && "1001" === t.returnCode) {
                                    ...
                                    i.removeClass("fav").addClass("faved").find(".fav-num").text( + e + 1),
                                    i.find(".isfav").removeClass("m-icon-star").addClass("m-icon-star-active")
                    ...
                    function() {
                        ...
                        if (e.pf = "mgjpc", e.mids = window.detailInfo.itemId, e.markType = 2, !t) {
                            ...
                            $.ajax({
                                ...
                                if (t.success && "1001" === t.returnCode) {
                                    var e = i.find(".fav-num").text();
                                    i.removeClass("faved").addClass("fav").find(".fav-num").text( + e - 1),
                                    i.find(".isfav").removeClass("m-icon-star-active").addClass("m-icon-star")
                                } else $.alert(t.message || "\u5f88\u62b1\u6b49\uff01\u7cfb\u7edf\u7e41\u5fd9\uff0c\u8bf7\u91cd\u8bd5")
                            }).fail(function() {
                                $.alert("\u7cfb\u7edf\u7e41\u5fd9")
                            }).always(function() {
                ...
                addqrcode: function() {
                    $(".mobile-qrcode-show").off(".qrcode").on("mouseenter.qrcode",
                    function() {
                        if ($self = $(this), $self.siblings(".qrcode-content").addClass("active"), !$self.data("isadd") && !$self.data("isLoading")) {
                            ...
                            $.ajax({
                                ...
                                $self.data("isadd", !0),
                                $self.data("isLoading", !1),
                                t.result && t.result.url ? $self.siblings(".qrcode-content").children(".qrcode").attr("src", t.result.url) : $self.siblings(".qrcode-content").children(".qrcode").attr("src", "//www.mogujie.com/trade/item_detail/qrcode?url=" + i)
                            }).fail(function() {
                                $self.data("isadd", !0),
                                $self.data("isLoading", !1),
                                $self.siblings(".qrcode-content").children(".qrcode").attr("src", "//www.mogujie.com/trade/item_detail/qrcode?url=" + i)
                            })
                        }
                    }).on("mouseleave.qc",
                    function() {
            ...
            D = {
                isBuy: function() {
                    var t = l.getStyleLen(),
                    e = l.getSizeLen();
                    if (t > 0 && e > 0) return P.filter.styleId && P.filter.sizeId ? 1 : 0;
                    if (t > 0 && 0 >= e) return P.filter.styleId ? 1 : 0;
                    if (0 >= t && e > 0) return P.filter.sizeId ? 1 : 0;
                    if (0 >= t && 0 >= e) {
                        var i = window.detailInfo.attribute;
                        return i && 1 == i.length ? (P.choose = i[0], 1) : 0
                    }
                },
                getParams: function() {
                    var t = {};
                    t.stockId = P.choose.stockId,
                    t.num = +y.find(".num-input").val(),
                    t.traceid = $("#traceid").val() || "",
                    t.cpcid = $("#cpcid").val() || "";
                    var e = {};
                    return e[P.choose.stockId] = s.getQueryString("ptp"),
                    t.ptp = JSON.stringify(e),
                    t.ptpdata = s.getQueryString("ptp"),
                    t.rushId = $("#J_RushId").val() || "",
                    t
                },
                getBuyURL: function(t, i) {
                    ...
                    case "CART":
                        n = [],
                        n.push("//cart.mogujie.com/cart/addcart")
                    }
                    var a = i.detailrefer.split("&ptp")[0];
                    return n.push("?stockId=" + i.stockId + "&number=" + i.num + "&traceid=" + i.traceid + "&tradeItemId=" + window.detailInfo.itemId + "&cpcid=" + i.cpcid + "&ptp=" + i.ptpdata + "&ptp_cnt=" + logger.ptp.getPtpCnt() + "&price=" + i.price, "&cdtype=" + i.cdtype, "&detailrefer=" + a, "&marketType=market_mogujie", "&iscosta=true"),
                    n.join("")
                }
            };
        ...
        n = function() {
            var t = {
                init: function(t, e) {
                    ...
                    l = 0,
                    d = !1;
                    t.find(".list").width(e.width).height(e.height).end().on("click", ".right-btn",
                    function() {
                        var t = $(this); - l >= r - e.width || d || (l -= e.width, n.animate({
                            left: l
                        },
                        "slow", "swing",
                        function() { - l >= r - e.width ? t.hide().prev().show() : t.prev().show(),
                            d = !1
                        }), d = !0)
                    }).on("click", ".left-btn",
                    function() {
                        ...
                        "slow", "swing",
                        function() {
                            0 >= -l ? t.hide().next().show() : t.next().show(),
                            d = !1
                        }), d = !0)
                    }),
                    n.addClass("carousel"),
                    t.find(".right-btn").show()
                }
            };
            return t
        }.call(e, i, e, t),
    ...
    function(t, e, i) {
        ...
        n = function() {
            ...
            i = function() {
                if ("undefined" != typeof e && e) {
                    for (var i = e.attribute || [], n = [], s = [], o = [], r = [], l = 0, d = i.length - 1; d >= 0; d--) i[d].styleId && (n.push(i[d].styleId), s.push(i[d].style)),
                    i[d].sizeId && (o.push(i[d].sizeId), r.push(i[d].size)),
                    l += i[d].stock || 0;
                    return n = a(n),
                    o = a(o),
                    t.styleLen = n.length,
            ...
            o = {
                ...
                getSkuItems: function() {
                    ...
                    if ("undefined" != typeof t && t) {
                        ...
                        if (o > 0) if (r > 0) for (var d = 0,
                        c = o; c > d; d++) {
                            l.style[a[d]] = {},
                            l.style[a[d]].stockId = {},
                            l.style[a[d]].stocks = {},
                            l.style[a[d]].sizeVals = {},
                            l.style[a[d]].nowprice = {},
                            l.style[a[d]].price = {},
                            l.style[a[d]].pinTuanPrice = {};
                            for (var u = 0,
                            p = d * r,
                            f = (d + 1) * r; f > p; p++) l.style[a[d]].stockId[n[p].sizeId] = n[p].stockId,
                            l.style[a[d]].stocks[n[p].sizeId] = n[p].stock,
                            l.style[a[d]].sizeVals[n[p].sizeId] = n[p].size,
                            l.style[a[d]].nowprice[n[p].sizeId] = n[p].nowprice,
                            l.style[a[d]].price[n[p].sizeId] = n[p].price,
                            l.style[a[d]].pinTuanPrice[n[p].sizeId] = n[p].pinTuanPrice,
                            l.style[a[d]].img = n[p].img,
                            l.style[a[d]].style = n[p].style,
                            0 === n[p].stock && ++u;
                            u == r && (l.style[a[d]].disable = !0)
                        } else for (var d = 0,
                        c = o; c > d; d++) l.style[a[d]] = {},
                        l.style[a[d]].stockId = n[d].stockId,
                        l.style[a[d]].stock = n[d].stock,
                        l.style[a[d]].img = n[d].img,
                        l.style[a[d]].style = n[d].style,
                        l.style[a[d]].nowprice = n[d].nowprice,
                        l.style[a[d]].price = n[d].price,
                        l.style[a[d]].pinTuanPrice = n[d].pinTuanPrice,
                        0 === n[d].stock && (l.style[a[d]].disable = !0);
                        if (r > 0) if (o > 0) for (var d = 0,
                        c = r; c > d; d++) {
                            l.size[s[d]] = {},
                            l.size[s[d]].stockId = {},
                            l.size[s[d]].stocks = {},
                            l.size[s[d]].styleVals = {},
                            l.size[s[d]].nowprice = {},
                            l.size[s[d]].price = {},
                            l.size[s[d]].pinTuanPrice = {};
                            for (var u = 0,
                            p = 0,
                            f = o; f > p; p++) {
                                var m = p * r + d;
                                l.size[s[d]].stockId[n[m].styleId] = n[m].stockId,
                                l.size[s[d]].stocks[n[m].styleId] = n[m].stock,
                                l.size[s[d]].styleVals[n[m].styleId] = n[m].style,
                                l.size[s[d]].nowprice[n[m].styleId] = n[m].nowprice,
                                l.size[s[d]].price[n[m].styleId] = n[m].price,
                                l.size[s[d]].pinTuanPrice[n[m].styleId] = n[m].pinTuanPrice,
                                l.size[s[d]].size = n[m].size,
                                0 === n[m].stock && ++u
                            }
                            u == o && (l.size[s[d]].disable = !0)
                        } else for (var d = 0,
                        c = r; c > d; d++) l.size[s[d]] = {},
                        l.size[s[d]].stockId = n[d].stockId,
                        l.size[s[d]].stock = n[d].stock,
                        l.size[s[d]].size = n[d].size,
                        l.size[s[d]].nowprice = n[d].nowprice,
                        l.size[s[d]].price = n[d].price,
                        l.size[s[d]].img = n[d].img,
                        l.size[s[d]].pinTuanPrice = n[d].pinTuanPrice,
                        0 === n[d].stock && (l.size[s[d]].disable = !0);
                        return l
                    }
                },
                ...
                getSkuItem: function(i, n) {
                    if (i || n) {
                        if (!t.styleLen && !t.sizeLen) return $.extend({},
                        e.attribute && e.attribute[0] || {});
                        var a = {};
                        ...
                        }: i.styleId ? a = n.style[i.styleId] : i.sizeId && (a = n.size[i.sizeId]),
                        a || {}
                    }
                }
            };
            ...
            i = {
                init: function(t, i, n) {
                    ...
                    d = function() {
                        ...
                        1 >= r && o.addClass("num-disable"),
                        r >= e && s.addClass("num-disable")
                    },
                    c = function(t, i) {
                        var n = "";
                        e ? n = "\u73b0\u4ef7\uff1a": (n = "\u4ef7\u683c\uff1a", $("#J_OriginPrice").text() && (n = "\u4fc3\u9500\u4ef7\uff1a")),
                        i >= t ? $(".property-type-now").text("\u798f\u5229\u4ef7\uff1a") : $(".property-type-now").text(n)
                    },
                    u = function() {
                        s.on("click",
                        function() {
                            if (!$(this).hasClass("num-disable")) {
                                var e = +t.attr("data-stock");
                                r = +a.val(),
                                /^\d+$/.test(r) && (++r, r > 1 && o.removeClass("num-disable"), a.val(r), i.trigger("stockTip", [r, e, t]), l && $("body").trigger("limitState", [r, e, l]), n > 0 && n + 1 >= r && ($("body").trigger("limitPriceNum", [r, n]), c(r, n)))
                            }
                        }),
                        o.on("click",
                        function() {
                            if (!$(this).hasClass("num-disable")) {
                                var e = +t.attr("data-stock");
                                r = +a.val(),
                                /^\d+$/.test(r) && !o.hasClass("num-disable") && (a.val(--r), 1 >= r && o.addClass("num-disable"), i.trigger("stockTip", [r, e, t]), l && $("body").trigger("limitState", [r, e, l]), n > 0 && n + 1 >= r && ($("body").trigger("limitPriceNum", [r, n]), c(r, n)))
                            }
                        }),
                        a.on("change",
                        function() {
                            var e = +t.attr("data-stock");
                            return r = +a.val(),
                            /^\d+$/.test(r) && 0 !== r && "" !== r ? (r > 1 && o.removeClass("num-disable"), 1 >= r && o.addClass("num-disable"), a.val(r), i.trigger("stockTip", [r, e, t]), void(n > 0 && ($("body").trigger("limitPriceNum", [r, n]), c(r, n)))) : (a.val(1), void i.trigger("stockTip", [1, e, t]))
                        })
                    },
                    p = function() {
                        d(),
        ...
        n = function() { !
            ...
            $.fly = function(t, e) {
                ...
                n.setOptions = function(t) {
                    ...
                    null != s.width && null != s.height && $.extend(!0, n, {
                        width: a.width(),
                        height: a.height()
                    });
    ...
    function(t, e, i) {
        ...
        a = function(t) {
            var e = {
                ...
                _initData: function() {
                    var t = this;
                    this._triggerCallBack("renderBefore", null),
                    this.itemId = s.getItemId(),
                    this.shopId = s.getShopId(),
                    this.userId = s.getShopUserId();
                    var e = $.extend(!0, {},
                    this._getAjaxParam(), {});
                ...
                _parsePromotionData: function(t) {
                    ...
                    c = !1,
                    u = [];
                    c = 2 >= r && 0 == l && 0 == d ? !1 : 0 == r && 1 >= l && 0 == d ? !1 : !(0 == r && 0 == l && 1 >= d),
                    u = r > 0 ? e.slice(0, 3) : 0 == r && l > 0 ? i.slice(0, 1) : n.slice(0, 1),
                    this.moduleData = {
                        needGetCouponList: e,
                ...
                _render: function() {
                    if (!this.moduleData || !this.moduleData.firstCouponList || 0 !== this.moduleData.firstCouponList.length) {
                        ...
                        this._triggerCallBack("renderAfter", null)
                    }
                },
                _events: function() {
                    this.moduleData.hasMore && $(".promotions-box").on("mouseenter",
                    function() {
    ...
    function(t, e, i) {
        var n, a, s = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ?
        function(t) {
            return typeof t
        }: function(t) {
    ...
    function(t, e) {
        ...
        function i(t, e, i) {
            ...
            this.options = {},
            this.$imgs = [],
            e && "object" === ("undefined" == typeof e ? "undefined": n(e)) && (this.options = $.extend({},
            this.options, e)),
            this.callback = e && "function" == typeof e ? e: i && "function" == typeof i ? i: null,
            this._getImgs(),
            this._on()
        }
        ...
        i.prototype._checkInView = function(t) {
            var e, i, n;
            return e = document.body.scrollTop || document.documentElement.scrollTop || window.pageYOffset || 0,
            i = window.innerHeight || document.documentElement.clientHeight,
            n = t.targetY ? t.targetY: this._getTargetY(t[0]),
            Math.abs(n - e) < i
        },
        ...
        i.prototype.throttle = function(t, e, i) {
            ...
            return function() {
                ...
                clearTimeout(a),
                n || (n = r),
                r - n >= i ? (t.apply(s, o), n = r) : a = setTimeout(function() {
                    t.apply(s, o)
                },
                e)
            }
        ...
        i.prototype._on = function() {
            ...
            u = e.throttle(function() {
                ...
                for (var a = 0; a < e.$imgs.length; a++) if (e.$imgs[a] && (t = e.$imgs[a], e._checkInView($(t)))) {
                    if ($(t).hasClass("loggered")) continue;
                    for (var u = 0; u < c.length; u++) d = {},
                    d[c[u]] = $(t).attr("data-" + c[u]),
                    r.push(d);
                    if ($(t).addClass("loggered"), e.counter++, r.length > 100) {
                        var p = r.splice(0, 100);
                        n = e._getPtpData(p),
                        window.logger && window.logger.log(e.options.eventId, n),
                        e.callback()
                    }
                }
                n = r && r.length && e._getPtpData(r),
                clearTimeout(l),
                l = setTimeout(function() {
                    r = [],
                    !$.isEmptyObject(n) && window.logger && window.logger.log(e.options.eventId, n),
                    console.log(n),
                    e.callback()
                },
                2e3)
            ...
            100, 0);
            e.counter = 0,
            i.on(s + " " + o, u).trigger(s)
        },
        i.prototype._getPtpData = function(t) {
            for (var e = {},
            i = 0; i < t.length; i++) {
                var n = t[i];
                for (var a in n) e[a] && e[a].length || (e[a] = []),
                e[a].push(n[a])
            }
            return e
        },
        ...
        a = function(t) {
            var e = {
                ...
                _initData: function() {
                    var t = this;
                    this.itemId = r.getItemId(),
                    this.rushId = r.getQueryString("objectId");
                    var e = $.extend(!0, {},
                    this._getAjaxParam(), {});
                    $.ajax(e).done(function(e) {
                        if (e) {
                ...
                init: function(e) {
                    $.ajax({
                        ...
                        if (1001 === n.code) {
                            var o = s.presale || {};
                            s.cpc = (s.cpc || 0) / 10 + "%",
                            o.presaleId && (o.start && (o.start = Date.format(new Date(o.start), "yyyy-MM-dd hh:mm:ss")), o.end && (o.end = Date.format(new Date(o.end), "yyyy-MM-dd hh:mm:ss")));
    ...
    function(t, e, i) {
        ...
        a = function() {
            var t = {
                test: function() {
                    s.getIsScreen() && $("body").off(".screen").on("click.screen",
                    function() {
                        return $(this).toggleClass("media_screen_1200 media_screen_960"),
                        !1
                    })
                }
            };
        ...
        a = function() {
            return window.__CFixed = window.__CFixed || {
                ...
                init: function() {
                    var t = this;
                    t.$win = $(window),
                    t.$win.off(".dfixed").on("scroll.dfixed",
                    function() {
                        t.scroll()
                    }),
                    t.scroll()
    ...
    function(t, e, i) {
        ...
        a = function() {
            var t = {
                ...
                settings: null,
                _initElem: function() {
                    this.$container = $("#J_ModuleTabpanel"),
                    this.$extraContainer = $(".col-extra")
                },
                _event: function() {
                    var t = this,
                    e = !0;
                    $(".tabbar-list", t.$container).off(".tab").on("click.tab", "li[data-panels]",
                    function() {
                        t._eventSwitch(this)
                    }),
                    $(".qrcode", t.$extraContainer).off(".qc").on("mouseenter.qc",
                    function() {
                        var t = $(this),
                        i = this;
                        if (t.addClass("active"), !t.data("isadd") && !t.data("isLoading")) {
                            ...
                            if (s.getPageTypeIsItem()) {
                                ...
                                n = "https://h5.mogujie.com/detail-" + r + "/index.html?itemId=" + s.getItemId() + "&QR_code=1",
                                s.isNewPrice() && (n = "https://m.mogujie.com/x6/new/detail/" + s.getItemId(), n += "?QR_code=1&activityId=" + s.getQueryString("activityId")),
                                a && (n += "&activityId=" + s.getQueryString("activityId"))
                            ...
                            $.ajax({
                                ...
                                t.data("isadd", !0),
                                t.data("isLoading", !1),
                                $(".qrcode-pic", this).html('<img src="//www.mogujie.com/trade/item_detail/qrcode?url=' + n + '">')
                            })
                        }
                    }).on("mouseleave.qc",
                    function() {
                ...
                _eventSwitch: function(t) {
                    ...
                    } catch(r) {} else if ("recommend" == n[0]) try {
                        window.logger && logger.log("016000104", {
                            tableName: "\u672c\u5e97\u540c\u7c7b\u5546\u54c1"
                        })
                    } catch(r) {} else try {
                    ...
                    if (0 != n.length) {
                        ...
                        e._trigger("switchBefore", l),
                        i.addClass("selected").data("isactived", "true").siblings("li[data-panels]").removeClass("selected"),
                        $("#J_ModuleExtranav").toggleClass("ui-none", !a),
                        $(".module-panel", e.$container).addClass("ui-none"),
                        $.each(n,
                        function(t, i) {
                            var n = $(".module-" + i, e.$container);
                            n.removeClass("ui-none"),
                            0 == t && 0 != n.length && s.goToTabPosition(n)
                        }),
    ...
    function(t, e, i) {
        ...
        a = function() {
            var t = {
                ...
                _shopFav: function(t) {
                    ...
                    if (!e.data("__isAjaxFav")) {
                        ...
                        return s.isLogin(n) ? void $.ajax({
                            ...
                            t.success ? t.success && "1001" === t.returnCode && "10012" === t.data.code ? e.removeClass("btn-faved").addClass("btn-fav").html("\u6536\u85cf\u5e97\u94fa") : t.success && "1001" === t.returnCode && "10011" === t.data.code && e.removeClass("btn-fav").addClass("btn-faved").html("\u5df2\u6536\u85cf") : $.alert(t.returnMessage || "\u6536\u85cf\u5931\u8d25\uff5e"),
                            e.data("__isAjaxFav", !1)
                ...
                _events: function() {
                    $("#J_ShopFav").on("click", this._shopFav),
                    $("#J_ShopSearch").on("submit", this._shopSearch)
                },
                init: function() {
                    this._initElem(),
                    this._initData(),
        ...
        a = function() {
            var t = {
                ...
                _showSubList: function() {
                    $item = $(this).siblings(".category-subList"),
                    $item.hasClass("show") ? $item.removeClass("show").addClass("hide").hide(200) : $item.hasClass("hide") && $item.removeClass("hide").addClass("show").show(200)
                },
                _events: function() {
        ...
        a = function(t) {
            ...
            i = {
                ...
                _render: function() {
                    var e = t.ui.getTemplate(l, this.moduleData);
                    this.$container.html(e),
                    $("img.lazy", this.$container).lazyload()
                },
                _initEvent: function() {
                    var t = this,
                    e = $(window);
                    t.$container.length && e.off(".m-repeat").on("scroll.m-repeat",
                    function() {
                        var i = e.scrollTop() + e.height() + 300; ! t._isLoaded && i > t.$container.offset().top && (t._isLoaded = !0, e.off(".m-repeat"), t._initData())
                    })
                },
                init: function() {
                    this._initElem(),
        ...
        function(t, e, i, n) {
            ...
            t.fn.lazyload = function(s) {
                function o() {
                    ...
                    l.each(function() {
                        var i = t(this);
                        if (!d.skip_invisible || i.is(":visible")) if (t.abovethetop(this, d) || t.leftofbegin(this, d));
                ...
                return s && (n !== s.failurelimit && (s.failure_limit = s.failurelimit, delete s.failurelimit), n !== s.effectspeed && (s.effect_speed = s.effectspeed, delete s.effectspeed), t.extend(d, s)),
                r = d.container === n || d.container === e ? a: t(d.container),
                0 === d.event.indexOf("scroll") && r.bind(d.event,
                function() {
                    return o()
                }),
                this.each(function() {
            ...
            t.belowthefold = function(i, s) {
                var o;
                return o = s.container === n || s.container === e ? (e.innerHeight ? e.innerHeight: a.height()) + a.scrollTop() : t(s.container).offset().top + t(s.container).height(),
                o <= t(i).offset().top - s.threshold
            },
            t.rightoffold = function(i, s) {
                var o;
                return o = s.container === n || s.container === e ? a.width() + a.scrollLeft() : t(s.container).offset().left + t(s.container).width(),
                o <= t(i).offset().left - s.threshold
            },
            t.abovethetop = function(i, s) {
                var o;
                return o = s.container === n || s.container === e ? a.scrollTop() : t(s.container).offset().top,
                o >= t(i).offset().top + s.threshold + t(i).height()
            },
            t.leftofbegin = function(i, s) {
                var o;
                return o = s.container === n || s.container === e ? a.scrollLeft() : t(s.container).offset().left,
                o >= t(i).offset().left + s.threshold + t(i).width()
            },
        ...
        a = function(t) {
            var e = {
                ...
                _initData: function() {
                    ...
                    this._getAjaxParam(), {});
                    t._trigger("loading", {}),
                    window.detailInfo && window.detailInfo.detailInfos || window.detailInfo && window.detailInfo.itemParams ? (this.moduleData = {
                ...
                _events: function() {
                    ...
                    t.off(".more").on("click.more", "a.more",
                    function() {
                        var t = $(this),
                        e = t.parent("td");
                        $curTR = e.parent("tr"),
                        $nextTRs = $curTR.nextAll("tr.ui-none"),
                        e.text(function() {
                            return t.data("text")
                        }),
    ...
    function(t, e, i) {
        ...
        r = (i(41), i(42)),
        l = i(43);
        window.log_stat_url_tmp = window.log_stat_url_tmp || "",
        n = [i(6)],
        a = function(t) {
            var e = (window.M && M.MWP || t && t.MWP || window.MWP || null, {
                $ratesBuyerBox: null,
                ...
                _initElemAfterDsr: function() {
                    this.$ratesBuyerBox = $("#J_RatesBuyer"),
                    this.$ratesBuyerList = $("#J_RatesBuyerList")
                },
                ...
                _getSettings: function(t) {
                    t.__rateShowWidthCSS = this._getRateShowWidthCSS(t.averageScore),
                    t.rateScore = t.rateScore || [];
                    for (var e = t.rateScore && t.rateScore.length || 0,
                    i = 0; e > i; i++) t.rateScore[i].__rateShowWidthCSS = this._getRateShowWidthCSS(t.rateScore[i].value);
                    return t
                },
                _randerDsr: function(e) {
                    ...
                    this.$rateModuleContainer.html(n),
                    this._initElemAfterDsr(),
                    this.showImg(),
                    this.switchTags(),
                    this.switchPage(),
                    this.switchExplain(),
                ...
                _render: function(e, i) {
                    ...
                    if (u > 1) {
                        ...
                        _postParams = $.extend(!0, {},
                        i || {},
                        f),
                        _linkPatams = $.map(_postParams,
                        function(t, e) {
                            return [e, t].join("=")
                        }).join("&"),
                        _link = "//rate.mogujie.com/jsonp/pc.rate.ratelist/v2?" + _linkPatams,
                        $(".pagination", s).pagination(d, {
                ...
                showImg: function() {
                    ...
                    function() {
                        ...
                        e.removeClass("c").slideUp();
                        else {
                            $(this).addClass("c").siblings().removeClass("c");
                            try {
                                window.logger && logger.log("016000109", {})
                            } catch(n) {}
                            e.find("img").attr("src", i.replace("100x100", "468x468")),
                            e.addClass("c").slideDown()
                        }
                ...
                switchTags: function() {
                    ...
                    function() {
                        ...
                        $(this).hasClass("c") ? ($(this).removeClass("c"), delete t.postParams.emotion, delete t.postParams.property) : ($(this).addClass("c").siblings("a").removeClass("c"), t.postParams.emotion = $(this).attr("data-emotion"), t.postParams.property = $(this).attr("data-property"), delete t.postParams.isImg),
                        MOGU && MOGU.Globe_Trace_Log("shop-detail-comment-tags"),
                        t.getComments();
                        var i = this.getAttribute("data-property");
                        i += "positive" == this.getAttribute("data-emotion") ? "_\u597d_": "_\u4e0d\u597d_",
                        i += $(this).text();
                        try {
                            window.logger && logger.log("016000104", {
                                tagName: i
                ...
                switchExplain: function() {
                    ...
                    i.on("click", ".show-explain",
                    function() {
                        $(this).closest(".item").find(".explain-box").show()
                    }).on("click", ".explain-submit",
                    function() {
                        var e = {},
                        i = $(this).closest(".item");
                        return e.rateId = $(this).attr("data-id"),
                        e.comment = $.trim(i.find(".explain-text").val()),
                        "" == e.comment ? void $.alert("\u8bf7\u8f93\u5165\u56de\u590d\u5185\u5bb9") : (e.isNewDetail = 1, e.marketType = "market_mogujie", void $.ajax({
                ...
                showComments: function() {
                    ...
                    function() {
                        if (e.find(".tags a").removeClass("c"), !$(this).hasClass("c")) {
                            ...
                            delete t.postParams.emotion,
                            delete t.postParams.property,
                            t.getComments()
                        }
                    }).on("click", ".J_CommentSort",
                    function() {
                        t.postParams.sort = $(this).attr("data-type"),
                        MOGU && MOGU.Globe_Trace_Log(1 == t.postParams.sort ? "shop-detail-comment-sort-default": "shop-detail-comment-sort-time");
                        var e = null;
            ...
            i = {
                ...
                getSales: function() {},
                _initElem: function() {
                    this.$ratesOrderBox = $("#J_RatesOrder"),
                    this.$ratesOrderList = $("#J_RatesOrderList")
                },
                init: function() {
                    this._initElem(),
                    this.switchPage()
        ...
        jQuery.fn.pagination = function(t, e) {
            ...
            this.each(function() {
                ...
                function a(t, i) {
                    ...
                    return n || (i.stopPropagation ? i.stopPropagation() : i.cancelBubble = !0),
                    n
                }
                function s() {
                    r.empty();
                ...
                t = !t || 0 > t ? 1 : t,
                e.items_per_page = !e.items_per_page || e.items_per_page < 0 ? 1 : e.items_per_page;
                var r = jQuery(this);
        ...
        a = function(t) {
            ...
            i = {
                ...
                _initEvent: function() {
                    ...
                    e = $(window),
                    i = $("#J_ModuleTabpanel");
                    i.length && e.off(".m-recommend").on("scroll.m-recommend",
                    function() {
                        var n = e.scrollTop() + e.height(); ! t._isLoaded && n > i.offset().top && (t._isLoaded = !0, e.off(".m-recommend"), t._initData())
                    })
                },
                init: function(t) {
                    this.__init || (this.__init = !0, this.settings = $.extend(!0, {},
                    this._defaults, t || {}), this._initElem(), this._initEvent())
                }
            };
            return i
        }.apply(e, n),
    ...
    function(t, e, i) {
        ...
        a = function(t) {
            var e = {
                ...
                _initElem: function() {
                    this.$win = $(window),
                    this.$container = $("#J_ModuleExtranav .extranav-bd"),
                    this._render()
                },
                _render: function() {
                    var e = t.ui.getTemplate(o, this.moduleData);
                ...
                _events: function() {
                    var t = this;
                    $(".extranav-list", this.$container).off(".nav").on("click.nav", "li",
                    function() {
                        t._eventGoTo(this)
                    }),
                    t.$win.off(".extranav-follow").on("scroll.extranav-follow",
                    function() {
                        t._eventFollow()
                    }),
                    t._eventFollow()
                ...
                _eventFollow: function() {
                    for (var t = this,
                    e = t.$win.scrollTop(), i = null, n = t.positionData.length - 1; n >= 0; n--) if (i = t.positionData[n], !(e + t.tabBarHeight < Math.floor(i.top))) {
                ...
                _eventGoTo: function(t) {
                    ...
                    0 != n.length && s.goToTabPosition(n, e.tabBarHeight),
                    !1
                },
        ...
        a = function() {
            var t = {
                ...
                _add: function() {
                    ...
                    $("#J_BuyCart:visible").trigger("click"),
                    $(".J_PannelOK:visible").eq(0).trigger("click")
                },
                _events: function() {
    ...
    function(t, e, i) {
        ...
        a = function(t) {
            var e = {
                ...
                _initData: function() {
                    this.itemId = s.getItemId(),
                    this.rushId = s.getRushId(),
                    this.moduleData = $.extend(!0, {},
                    this.moduleData, s.getRushData() || {}),
                    this.moduleData.__buy = {
                        state: this._getBuyState(this.moduleData.state)
                    }
                },
                _initElem: function() {
                    this.$container = $("#J_ModuleRushBuy"),
                    this._beforeFiveMinu(),
                ...
                _beforeFiveMinu: function() {
                    ...
                    if (0 == e.state) {
                        ...
                        t.timer = setInterval(function() {
                            i -= 1,
                            300 >= i && (clearInterval(t.timer), t._updateForState(4))
                        },
                        1e3)
                    }
                },
                ...
                _getRefreshParam: function() {
                    ...
                    return s.getQueryString("_state") && (t.data._state = s.getQueryString("_state")),
                    s.getQueryString("_countdown") && (t.data._countdown = s.getQueryString("_countdown")),
                    t
                },
                _refresh: function(t) {
                    function e(t) {
                    ...
                    if (!i.__isRefresh) {
                        i.__isRefresh = !0,
                        i.__waitMilliseconds = 0,
                        clearInterval(i.__timer2),
                        i.__timer2 = setInterval(function() {
                            i.__waitMilliseconds += 100,
                            i.__waitMilliseconds > 1e3 && clearInterval(i.__timer2)
                        },
                        100),
                        t.addClass("buy-loading").html("<em>\u6b63\u5728\u5237\u65b0<i></i></em>");
                        var a = $.extend(!0, i._getRefreshParam(), {});
                        $.ajax(a).done(function(t) {
                            try {
                                t = JSON.parse(t.replace(/\\"/gim, '"')),
                                console.log("esi \u66f4\u65b0\u6570\u636e\u5982\u4e0b\uff1a"),
                                console.log(t)
                            } catch(a) {}
                            ...
                            $.alert(t.result || t.status.msg, 2e3)
                        }).fail(function() {
                            e(n)
                        })
                    }
                ...
                _events: function() {
                    var t = this;
                    t.$container.on("rushbuy", 'a[data-type="buynow"]',
                    function() {
                        var e = $(this),
                        i = e.data("params"),
                        n = {
                    ...
                    t.$container.off(".rf").on("click.rf", 'a[data-type="refresh"]',
                    function() {
                        t._refresh($(this))
                    })
                },
                ...
                _showProcessBox: function() {
                    ...
                    e = new MGLightBox(t);
                    e.init(),
                    $("#J_RushProcessBox").find(".lb_hd").remove()
                },
                _checkResult: function(t) {
                    function e() {
                        $("#J_RushProcessBox").remove(),
                        clearInterval(n),
                        a.__isAjaxCheck = !1
                    }
                    var i, n, a = this,
            ...
            var t = {
                ...
                start: function() {
                    ...
                    t.__isStart || (t.__isStart = !0, t._timer = setInterval(function() {
                        ...
                        e.timeStamp < 0 ? (clearInterval(t._timer), t.__isStart = !1, t._trigger("done", {
                            content: ""
                        })) : t._trigger("loop", {
    ...
    function(t, e, i) {
        ...
        a = function(t) {
            var e = {
                ...
                _initData: function() {
                    this.itemId = s.getItemId(),
                    this.moduleData = s.getPreSaleRulesData()
                },
                _render: function() {
                    if (null == this.$container) {
                        var e = t.ui.getTemplate(o, this.moduleData);
                        $("body").append(e),
                        this.$container = $("#J_ModulePreSaleRules"),
                        this._renderAfterEvents()
                    }
                },
                ...
                _showAfterEvents: function() {
                    var t = this;
                    $(window).off(".mpsr").on("resize.mpsr",
                    function() {
                        t._position()
                    }),
                    $("body").off(".mpsr").on("click.mpsr",
                    function() {
                ...
                _toggle: function() {
                    ...
                    this.__isShow ? (this._render(), this.$container.show(), this._position(), this._showAfterEvents()) : (this.$container.hide(), this._hideAfterEvents())
                },
                _position: function() {
                    if (this.__isShow) {
                ...
                init: function() {
                    ...
                    a.length ? (i.append(t.ui.getTemplate(s, a)), i.find("[data-link]").each(function() {
                        ...
                        e && e.request("mwp.darwin.get", "3", {
                            ...
                            i.find(".modal-pintuan-rule .content").html(n),
                            i.find(".modal-pintuan-rule, .modal-mask").show()
                        })
            ...
            t.fn.qrcode = function(e) {
                ...
                n.prototype = {
                    ...
                    make: function() {
                        if (1 > this.typeNumber) {
                            ...
                            t = 1; 40 > t; t++) {
                                ...
                                for (a = 0; a < this.dataList.length; a++) e = this.dataList[a],
                                i.put(e.mode, 4),
                    ...
                    setupPositionProbePattern: function(t, e) {
                        for (var i = -1; 7 >= i; i++) if (! ( - 1 >= t + i || this.moduleCount <= t + i)) for (var n = -1; 7 >= n; n++) - 1 >= e + n || this.moduleCount <= e + n || (this.modules[t + i][e + n] = i >= 0 && 6 >= i && (0 == n || 6 == n) || n >= 0 && 6 >= n && (0 == i || 6 == i) || i >= 2 && 4 >= i && n >= 2 && 4 >= n)
                    },
                    ...
                    setupPositionAdjustPattern: function() {
                        for (var t = l.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++) for (var i = 0; i < t.length; i++) {
                            var n = t[e],
                            a = t[i];
                            if (null == this.modules[n][a]) for (var s = -2; 2 >= s; s++) for (var o = -2; 2 >= o; o++) this.modules[n + s][a + o] = -2 == s || 2 == s || -2 == o || 2 == o || 0 == s && 0 == o
                        }
                    },
                    ...
                    setupTypeInfo: function(t, e) {
                        ...
                        for (n = 0; 15 > n; n++) a = !t && 1 == (i >> n & 1),
                        8 > n ? this.modules[8][this.moduleCount - n - 1] = a: 9 > n ? this.modules[8][15 - n - 1 + 1] = a: this.modules[8][15 - n - 1] = a;
                    ...
                    mapData: function(t, e) {
                        ...
                        o = this.moduleCount - 1; o > 0; o -= 2) for (6 == o && o--;;) {
                            for (var r = 0; 2 > r; r++) if (null == this.modules[n][o - r]) {
                                var d = !1;
                                s < t.length && (d = 1 == (t[s] >>> a & 1)),
                                l.getMask(e, n, o - r) && (d = !d),
                                this.modules[n][o - r] = d,
                                a--,
                                -1 == a && (s++, a = 7)
                            }
                ...
                n.createData = function(t, e, i) {
                    for (var e = s.getRSBlocks(t, e), a = new o, r = 0; r < i.length; r++) {
                        var d = i[r];
                        a.put(d.mode, 4),
                        a.put(d.getLength(), l.getLengthInBits(d.mode, t)),
                        d.write(a)
                    }
                ...
                n.createBytes = function(t, e) {
                    ...
                    n = 0,
                    s = 0,
                    o = Array(e.length), r = Array(e.length), d = 0; d < e.length; d++) {
                        var c = e[d].dataCount,
                        u = e[d].totalCount - c,
                        n = Math.max(n, c),
                        s = Math.max(s, u);
                        ...
                        for (i += c, p = l.getErrorCorrectPolynomial(u), c = new a(o[d], p.getLength() - 1).mod(p), r[d] = Array(p.getLength() - 1), p = 0; p < r[d].length; p++) u = p + c.getLength() - r[d].length,
                        r[d][p] = u >= 0 ? c.get(u) : 0
                    }
                    for (p = d = 0; p < e.length; p++) d += e[p].totalCount;
                    for (i = Array(d), p = c = 0; n > p; p++) for (d = 0; d < e.length; d++) p < o[d].length && (i[c++] = o[d][p]);
                    for (p = 0; s > p; p++) for (d = 0; d < e.length; d++) p < r[d].length && (i[c++] = r[d][p]);
                    return i
                },
                r = 4;
                for (var l = {
                    ...
                    getLostPoint: function(t) {
                        for (var e = t.getModuleCount(), i = 0, n = 0; e > n; n++) for (var a = 0; e > a; a++) {
                            for (var s = 0,
                            o = t.isDark(n, a), r = -1; 1 >= r; r++) if (! (0 > n + r || n + r >= e)) for (var l = -1; 1 >= l; l++) 0 > a + l || a + l >= e || 0 == r && 0 == l || o == t.isDark(n + r, a + l) && s++;
                            s > 5 && (i += 3 + s - 5)
                        }
                        for (n = 0; e - 1 > n; n++) for (a = 0; e - 1 > a; a++) s = 0,
                        t.isDark(n, a) && s++,
                        t.isDark(n + 1, a) && s++,
                        t.isDark(n, a + 1) && s++,
                        t.isDark(n + 1, a + 1) && s++,
                        (0 == s || 4 == s) && (i += 3);
                        for (n = 0; e > n; n++) for (a = 0; e - 6 > a; a++) t.isDark(n, a) && !t.isDark(n, a + 1) && t.isDark(n, a + 2) && t.isDark(n, a + 3) && t.isDark(n, a + 4) && !t.isDark(n, a + 5) && t.isDark(n, a + 6) && (i += 40);
                        for (a = 0; e > a; a++) for (n = 0; e - 6 > n; n++) t.isDark(n, a) && !t.isDark(n + 1, a) && t.isDark(n + 2, a) && t.isDark(n + 3, a) && t.isDark(n + 4, a) && !t.isDark(n + 5, a) && t.isDark(n + 6, a) && (i += 40);
                        for (a = s = 0; e > a; a++) for (n = 0; e > n; n++) t.isDark(n, a) && s++;
                        return t = Math.abs(100 * s / e / e - 50) / 5,
                        i + 10 * t
                    }
                },
                d = {
                ...
                s.getRSBlocks = function(t, e) {
                    ...
                    a = [], o = 0; n > o; o++) for (var r = i[3 * o + 0], l = i[3 * o + 1], d = i[3 * o + 2], c = 0; r > c; c++) a.push(new s(l, d));
                    return a
                },
                ...
                this.each(function() {
                    ...
                    if ("canvas" == e.render) {
                        ...
                        a.width = e.width,
                        a.height = e.height;
                        for (var s = a.getContext("2d"), o = e.width / i.getModuleCount(), r = e.height / i.getModuleCount(), l = 0; l < i.getModuleCount(); l++) for (var d = 0; d < i.getModuleCount(); d++) {
                    ...
                    } else for (i = new n(e.typeNumber, e.correctLevel), i.addData(e.text), i.make(), a = t("<table></table>").css("width", e.width + "px").css("height", e.height + "px").css("border", "0px").css("border-collapse", "collapse").css("background-color", e.background), s = e.width / i.getModuleCount(), o = e.height / i.getModuleCount(), r = 0; r < i.getModuleCount(); r++) for (l = t("<tr></tr>").css("height", o + "px").appendTo(a), d = 0; d < i.getModuleCount(); d++) t("<td></td>").css("width", s + "px").css("background-color", i.isDark(r, d) ? e.foreground: e.background).appendTo(l);
                    i = a,
        ...
        a = function(t) {
            var e = {
                ...
                _render: function() {
                    ...
                    this.$dapeiContainer.html(e),
                    this.moduleData.collcationSet.length > 0 && i.show(1e3)
                },
                _initEvents: function() {
                    var t = this;
                    $(".dapei-tab-item");
                    $(".dapei-tab-item", t.$dapeiContainer).off(".tab").on("click.tab",
                    function(t) {
                        $(this).siblings("li").removeClass("active"),
                        $(this).addClass("active");
                        var e = $(this).attr("data-mark");
                        $(".dapei-item").removeClass("dapei-show"),
                        $(".dapei-item").removeClass("dapei-hide"),
                        $('.dapei-item[data-mark!="' + e + '"]').addClass("dapei-hide"),
                        $('.dapei-item[data-mark="' + e + '"]').addClass("dapei-show")
                    }),
                    $(".dapei-page-up", t.$dapeiContainer).off(".pageup").on("click.pageup",
                    function(e) {
                    ...
                    $(".dapei-page-down", t.$dapeiContainer).off(".pagedown").on("click.pagedown",
                    function(e) {
                        var i = $(".dapei-tab-item.active").attr("data-mark"),
                        n = $('.dapei-item[data-mark="' + i + '"]'),
                    ...
                    $(".dapei-sku-select", t.$dapeiContainer).off(".skuselect").on("click.skuselect",
                    function(e, i) {
                        if ("true" !== i) if ("false" === $(this).attr("show-body")) {
                            $(this).attr("show-body", "true"),
                            $(this).parent().siblings(".dapei-body-items-item").children(".dapei-sku-select").attr("show-body", "false"),
                            $(this).parent().siblings(".dapei-body-items-item").children(".dapei-sku-body").hide(),
                            $(this).siblings(".dapei-sku-body").show();
                            var n = $(".col-top").width(),
                            ...
                            300)
                        } else $(this).attr("show-body", "false"),
                        $(this).siblings(".dapei-sku-body").hide();
                        var c = $(this).attr("data-stockId");
                        c ? $(this).siblings(".dapei-sku-body").trigger("revertSku", [c]) : $(this).siblings(".dapei-sku-body").trigger("revertSku"),
                    ...
                    t.$dapeiContainer.off("dapeiCalPrice").on("dapeiCalPrice",
                    function() {
                        $(".dapei-item").each(function(t, e) {
                            var i = 0,
                            n = 0;
                            stockIdArr = [],
                            $(e).find(".dapei-body-items li").each(function(t, e) {
                                if ($(e).find(".dapei-checkbox input").prop("checked") && $(e).find(".dapei-sku-select").attr("data-stockid")) {
                                    var a = $(e).find(".dapei-sku-select");
                                    i += parseInt(a.attr("data-nowprice")),
                                    n += parseInt(a.attr("data-price")),
                                    stockIdArr.push({
                            ...
                            $(e).find(".dapei-buy .dapei-buy-price-price").text("\xa5" + i / 100),
                            $(e).find(".dapei-buy .dapei-buy-save-price").text((n - i) / 100)
                        })
                    }),
                    t.$dapeiContainer.off("dapeiShow").on("dapeiShow",
                    function(t, e, i) {
                        var n = $(".dapei-body-items", i).attr("data-page-all");
                        $(".dapei-body-items-item", i).siblings().removeClass("dapei-body-items-item-show"),
                        $('.dapei-body-items-item[data-page="' + e + '"]', i).addClass("dapei-body-items-item-show"),
                        $('.dapei-body-items-item[data-index="true"]', i).addClass("dapei-body-items-item-show"),
                        $(".dapei-body-items", i).attr("data-page-now", e);
                        var a = $(".dapei-page-up", i),
                        s = $(".dapei-page-down", i);
                        a.siblings().removeClass("disabled"),
                        s.siblings().removeClass("disabled"),
                        1 == e && a.addClass("disabled"),
                        e == n && s.addClass("disabled")
                    }),
                    ...
                    $(".dapei-buy-now", t.$dapeiContainer).off("buynow").on("click.buynow",
                    function() {
                ...
                _doConfirmSku: function(t, e) {
                    var i = this;
                    $.confirm("\u8bf7\u786e\u8ba4\u4ee5\u4e0b\u5546\u54c1\u4fe1\u606f\u662f\u5426\u6b63\u786e\u54e6\uff1a<br/>" + t.skuTextList.join("<br/>"),
                    function(e) {
                ...
                _initSku: function() {
                    var t = this;
                    t.skus = [],
                    t.moduleData.collcationSet.forEach(function(t, e) {
                    ...
                    t.find(".dapei-body-items-item").each(function(u, p) {
                        if ($(p).find(".dapei-checkbox input").prop("checked")) {
                            ...
                            if (c++, !(g && m && v)) {
                                ...
                                return e.$dapeiContainer.trigger("dapeiShow", [y, t]),
                                f.trigger("click"),
                                o = !1,
                                !1
                            }
                            ...
                            a.push([h, m].join(",")),
                            s.push([g, m].join(",")),
                            r[h] = MGTOOL.getQueryString("ptp"),
                            l[g] = MGTOOL.getQueryString("ptp"),
                            d.push(_)
                        }
                    });
    ...
    function(t, e, i) {
        ...
        a = function(t) {
            var e = function(t, e, i) {
                this.isDefaultChoose = i || !1,
                this.$container = t,
                this.$goodsStock = t.find(".stock"),
                this.$goodsPrice = t.siblings(".dapei-body-items-item-price").find(".dapei-item-price"),
                this.$goodsNum = t.find(".sku-counter"),
                this.$bigImg = t.siblings(".dapei-body-items-item-img-a").children(".dapei-body-items-item-img"),
                this.$sizeSkuContainer = t.find(".size-list"),
                this.$styleSkuContainer = t.find(".style-list"),
                this.skuItems = {},
                this.filter = {},
                this.choose = null,
                this.num = 1,
                this.stock = 0,
                this.skuData = e,
                this.styleSetDefaultFlag = !i,
                this.sizeSetDefaultFlag = !i,
                this.SkuData = new r,
                this.domRender = this.render(),
                this.domRender.init(),
                this.fn = this.fn(),
                this.domEvent = this.event(),
                this.domEvent.init()
            };
            return e.prototype.render = function() {
                ...
                return {
                    init: function() {
                        e.SkuData.sku.setData(e.skuData),
                        this.sku(),
                        this.stock(e.SkuData.sku.getTotalStock())
                    },
                    sku: function() {
                        var i = null;
                        try {
                        ...
                        if ("undefined" != typeof i && i) {
                            ...
                            if (a && s > 0) {
                                for (var p in a) {
                                    ...
                                    if (a[p].img && "" != a[p].img) {
                                        var m = a[p].img;
                                        m = this._transformImgUrl(m) + "_100x100.jpg",
                                        f = {
                                            className: "img",
                                            id: p,
                                            title: a[p].style,
                                    ...
                                    a[p].disable || e.filter.sizeId && 0 == a[p].stocks[e.filter.sizeId] ? f.className = f.className + " disable": 1 != s && e.styleSetDefaultFlag || (e.styleSetDefaultFlag = !0, f.className = f.className + " c", e.filter.styleId = p),
                                    c.push(t.ui.getTemplate(o, f))
                                }
                            ...
                            if (r && d > 0) {
                                for (var p in r) {
                                    ...
                                    r[p].disable || e.filter.styleId && 0 == r[p].stocks[e.filter.styleId] ? f.className = f.className + " disable": 1 != d && e.sizeSetDefaultFlag || (e.sizeSetDefaultFlag = !0, f.className = f.className + " c", e.filter.sizeId = p),
                                    u.push(t.ui.getTemplate(o, f))
                                }
                    ...
                    stock: function(t) {
                        e.$goodsStock.text(t),
                        e.$goodsNum.attr("data-stock", t),
                        e.$container.trigger("dapeiGetStock", [t]),
                        e.$container.trigger("dapeiChangeNumBtnState", [e.num, t])
                    },
                    list: function(t) {
                        var i = t.stocks,
                        n = 0;
            ...
            e.prototype.event = function() {
                ...
                return {
                    init: function() {
                        ...
                        this.revertSku(),
                        this.changeSku(),
                        this.changeSkuForPrimary(),
                        this.confirmSku()
                    },
                    chooseSku: function() {
                        t.$container.on("click", "ul li:not(.disable)",
                        function() {
                            t.$container.trigger("dapeiUpdateSku", [$(this)]),
                            "true" === t.$container.parent().attr("data-index") && $("body").trigger("primarySkuSelect", [t.filter])
                        })
                    },
                    dapeiUpdateSku: function() {
                        t.$container.on("dapeiUpdateSku",
                        function(e, i) {
                            var n = i.closest("ul");
                            if (i.hasClass("c")) {
                                if (n.hasClass("J_StyleList")) {
                            ...
                            n.hasClass("J_StyleList") && (t.filter.styleId = i.data("id"), t.filter.type = "style", i.hasClass("img") && (t.$bigImg[0].src = i.children("img")[0].src.replace("100x100", "160x160"))),
                            n.hasClass("J_SizeList") && (t.filter.sizeId = i.data("id"), t.filter.type = "size"),
                            t.domRender.fresh()
                        })
                    },
                    dapeiGetNum: function() {
                        t.$container.on("dapeiGetNum",
                        function(e, i) {
                            t.num = i
                        })
                    },
                    dapeiGetStock: function() {
                        t.$container.on("dapeiGetStock",
                        function(e, i) {
                            t.stock = i
                        })
                    },
                    confirmSku: function() {
                        t.$container.find(".pannel-action .confirm").on("click",
                        function(e, i) {
                            if (t.choose && t.choose.size && t.choose.style && t.choose.stockId) {
                                ...
                                t.$container.siblings(".dapei-sku-select").find("span").text(t.choose.size + "," + t.choose.style + "," + n + "\u4ef6"),
                                t.$container.siblings(".dapei-sku-select").attr("data-stockId", t.choose.stockId),
                                t.$container.siblings(".dapei-sku-select").attr("data-stockId2", t.choose.stockId2),
                                t.$container.siblings(".dapei-sku-select").attr("data-price", t.choose.price),
                                t.$container.siblings(".dapei-sku-select").attr("data-nowprice", t.choose.nowprice),
                                t.$container.siblings(".dapei-sku-select").attr("data-num", t.choose.num),
                                "true" === i ? t.$container.siblings(".dapei-sku-select").trigger("click", ["true"]) : t.$container.siblings(".dapei-sku-select").trigger("click");
                                try {
                            ...
                            } else t.$container.find(".J_GoodsStockTip").text("\u8bf7\u9009\u62e9\u989c\u8272\u548c\u5c3a\u7801!").show(),
                            setTimeout(function() {
                    ...
                    closeSku: function() {
                        t.$container.find(".pannel-close").on("click",
                        function() {
                            t.$container.siblings(".dapei-sku-select").trigger("click")
                        })
                    },
                    stockTip: function() {
                        t.$container.on("stockTip",
                        function(e, i, n, a) {
                            var s = a ? a.siblings(".goods-stock-tip") : $goodsSku.find(".J_GoodsStockTip");
                            t.choose.num = i,
                            t.$container.find(".J_GoodsStockTip").text("\u60a8\u6240\u586b\u5199\u7684\u5546\u54c1\u6570\u91cf\u8d85\u8fc7\u5e93\u5b58!"),
                            +i > +n ? (s.show(), t.choose.isStock = !1) : (s.hide(), t.choose.isStock = !0)
                        })
                    },
                    revertSku: function() {
                        t.$container.on("revertSku",
                        function(e, i) {
                            if (i) {
                    ...
                    changeSku: function() {
                        ...
                        function(e, i) {
                            ...
                            t.$container.trigger("dapeiUpdateSku", [a]),
                            t.$container.find(".pannel-action .confirm").trigger("click", ["true"])
                        })
                    },
                    changeSkuForPrimary: function() {
                        $("body").on("primarySkuSelect",
                        function(t, e) {
    ...
    function(t, e, i) {
        ...
        n = function() {
            var t = function() {
                ...
                this.data = {},
                this.sku = this.fn(),
                this.parseSkuData = function() {
                    if ("undefined" != typeof this.skuData && this.skuData) {
                        for (var t = this.skuData,
                        e = [], i = [], n = [], a = [], s = 0, o = t.length - 1; o >= 0; o--) t[o].styleId && (e.push(t[o].styleId), i.push(t[o].img)),
                        t[o].sizeId && (n.push(t[o].sizeId), a.push(t[o].size)),
                        s += t[o].stock || 0;
                        return e = this.unique(e),
                        n = this.unique(n),
                        this.data.styleLen = e.length,
                        this.data.sizeLen = n.length,
                        this.data.totalStock = s,
                        {
                            styleIds: e,
                            sizeIds: n
                        }
                ...
                e = {
                    ...
                    getSkuItems: function() {
                        ...
                        if ("undefined" != typeof e && e) {
                            ...
                            if (s > 0) if (o > 0) for (var l = 0,
                            d = s; d > l; l++) {
                                r.style[n[l]] = {},
                                r.style[n[l]].stockId = {},
                                r.style[n[l]].stockId2 = {},
                                r.style[n[l]].stocks = {},
                                r.style[n[l]].sizeVals = {},
                                r.style[n[l]].price = {},
                                r.style[n[l]].nowprice = {};
                                for (var c = 0,
                                u = l * o,
                                p = (l + 1) * o; p > u; u++) r.style[n[l]].stockId[i[u].sizeId] = i[u].stockId,
                                r.style[n[l]].stockId2[i[u].sizeId] = i[u].stockId2,
                                r.style[n[l]].stocks[i[u].sizeId] = i[u].stock,
                                r.style[n[l]].sizeVals[i[u].sizeId] = i[u].size,
                                r.style[n[l]].price[i[u].sizeId] = i[u].price,
                                r.style[n[l]].nowprice[i[u].sizeId] = i[u].nowprice,
                                r.style[n[l]].style = i[u].style,
                                r.style[n[l]].img = i[u].img,
                                r.style[n[l]].currency = i[u].currency,
                                0 === i[u].stock && ++c;
                                c == o && (r.style[n[l]].disable = !0)
                            } else for (var l = 0,
                            d = s; d > l; l++) r.style[n[l]] = {},
                            r.style[n[l]].stockId = i[l].stockId,
                            r.style[n[l]].stockId2 = i[l].stockId2,
                            r.style[n[l]].stock = i[l].stock,
                            r.style[n[l]].style = i[l].style,
                            r.style[n[l]].price = i[l].price,
                            r.style[n[l]].nowprice = i[l].nowprice,
                            r.style[n[l]].img = i[l].img,
                            r.style[n[l]].currency = i[l].currency,
                            0 === i[l].stock && (r.style[n[l]].disable = !0);
                            if (o > 0) if (s > 0) for (var l = 0,
                            d = o; d > l; l++) {
                                r.size[a[l]] = {},
                                r.size[a[l]].stockId = {},
                                r.size[a[l]].stockId2 = {},
                                r.size[a[l]].stocks = {},
                                r.size[a[l]].styleVals = {},
                                r.size[a[l]].price = {},
                                r.size[a[l]].nowprice = {};
                                for (var c = 0,
                                u = 0,
                                p = s; p > u; u++) {
                                    var f = u * o + l;
                                    r.size[a[l]].stockId[i[f].styleId] = i[f].stockId,
                                    r.size[a[l]].stockId2[i[f].styleId] = i[f].stockId2,
                                    r.size[a[l]].stocks[i[f].styleId] = i[f].stock,
                                    r.size[a[l]].styleVals[i[f].styleId] = i[f].style,
                                    r.size[a[l]].nowprice[i[f].styleId] = i[f].nowprice,
                                    r.size[a[l]].price[i[f].styleId] = i[f].price,
                                    r.size[a[l]].size = i[f].size,
                                    r.size[a[l]].img = i[f].img,
                                    r.size[a[l]].currency = i[f].currency,
                                    0 === i[f].stock && ++c
                                }
                                c == s && (r.size[a[l]].disable = !0)
                            } else for (var l = 0,
                            d = o; d > l; l++) r.size[a[l]] = {},
                            r.size[a[l]].stockId = i[l].stockId,
                            r.size[a[l]].stockId2 = i[l].stockId2,
                            r.size[a[l]].stock = i[l].stock,
                            r.size[a[l]].size = i[l].size,
                            r.size[a[l]].nowprice = i[l].nowprice,
                            r.size[a[l]].price = i[l].price,
                            r.size[a[l]].img = i[l].img,
                            r.size[a[l]].currency = i[l].currency,
                            0 === i[l].stock && (r.size[a[l]].disable = !0);
                            return r
                        }
                    }
                };
            ...
            var e = {
                ...
                initDom: function() {
                    ...
                    if (this.h5Link || this.xcxLink) {
                        ...
                        a = "",
                        s = "";
                        this.h5Link && this.xcxLink ? (e = "\u8611\u83c7\u8857\u65e0\u7ebf\u7aef\u4e13\u4eab\u5546\u54c1", i = "\u8be5\u5546\u54c1\u4e3a\u8611\u83c7\u8857APP\u548c\u8611\u83c7\u8857\u5973\u88c5\u7cbe\u9009\u5c0f\u7a0b\u5e8f\u4e13\u4eab\uff0c\u8bf7\u626b\u4ee5\u4e0b\u4e8c\u7ef4\u7801\u8fdb\u884c\u6d4f\u89c8\u54e6", n = 'style="height:349px;"', a = 'style="padding:0 113px;"', s = 'style="margin-left:33px;"') : this.h5Link ? (e = "\u8611\u83c7\u8857APP\u4e13\u4eab\u5546\u54c1", i = "\u8be5\u5546\u54c1\u4e3a\u8611\u83c7\u8857APP\u4e13\u4eab\uff0c\u8bf7\u626b\u4ee5\u4e0b\u4e8c\u7ef4\u7801\u8fdb\u884c\u6d4f\u89c8\u54e6") : (e = "\u8611\u83c7\u8857\u5973\u88c5\u5c0f\u7a0b\u5e8f\u4e13\u4eab\u5546\u54c1", i = "\u8be5\u5546\u54c1\u4e3a\u8611\u83c7\u8857\u5973\u88c5\u5c0f\u7a0b\u5e8f\u4e13\u4eab\uff0c\u8bf7\u626b\u4ee5\u4e0b\u4e8c\u7ef4\u7801\u8fdb\u884c\u6d4f\u89c8\u54e6"),
                        ...
                        this.$dom = $("#J_ModuleNavModal"),
                        this.$dom.on("click", ".wrapper .m-icon-close",
                        function() {
                            t.$dom.hide()
                        }),
                        this.loadQRcode()
                ...
                init: function() {
                    ...
                    i && i.request("mwp.darwin.get", "3", {
                        ...
                        if (n.length) {
                            ...
                            c = d ? e.isToday(d) : !1;
                            $("#J_ModuleCustomProperty").html(r),
                            $("#J_ModuleCustomProperty").show(),
                            c || ($("#J_ModuleCustomBanner").html(l), $("#J_ModuleCustomBanner").show()),
                            $("#J_ModuleCustomBanner .m-icon-close").click(function() {
                                $("#J_ModuleCustomBanner").remove(),
                                window.localStorage && window.localStorage.setItem(a, (new Date).getTime())
                            })
                        }
                    })
                },
