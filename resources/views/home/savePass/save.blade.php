            ...
            <div class="registerbox">
                ...
                <div class="reg_bd find_pwd_wrap ui-validation-content">
                    ...
                    <div id="modelform" class="formbox info_verify_box">
                        <form action="" class="formelem" method="post">
                            <ul>
                                <li>
                                    {{csrf_field()}}
                                    <div class="ui-item inputbox validateitem ui-name" style="margin-left:55px">
                                        ...
                                        <input type="password" name="password" value="" data-type="username" class="ui-input normalText display_u js_text_input js_uname"
                                        placeholder="请输入新密码 ">
                                    </div>
                                </li>
                            ...
                            <ul>
                                <li>
                                    <div class="ui-item inputbox validateitem ui-name" style="margin-left:38px">
                                        <span class="accountLabel">
                                            确认密码:
                                        </span>
                                        <input type="password" name="repass" value="" data-type="pass" class="ui-input normalText display_u js_text_input js_uname"
                                        placeholder="请确认密码 ">
                                    </div>
                                </li>
                                <li class="lg_chk_wrap">
